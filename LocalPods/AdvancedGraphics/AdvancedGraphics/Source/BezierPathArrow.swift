...
extension UIBezierPath {
    func arrow(from: CGPoint,
        ...
        let arrowLine1 = CGPoint(x: to.x +
                                 pointerLength * cos(CGFloat(Double.pi) - startEndAngle + angle),
                                 y: to.y -
                                 pointerLength * sin(CGFloat(Double.pi) - startEndAngle + angle)
        )
        let arrowLine2 = CGPoint(x: to.x +
                                 pointerLength * cos(CGFloat(Double.pi) - startEndAngle - angle),
                                 y: to.y -
                                 pointerLength * sin(CGFloat(Double.pi) - startEndAngle - angle)
        )
