...
class ThreeRecomendationCoffeeStackView: UIStackView {
    ...
    private lazy var reccomendationCoffeeStackViewLeft = RecomendationCoffeeStackView(text: recomendations[0].0,
                                                                                      image: recomendations[0].1)
    private lazy var reccomendationCoffeeStackViewMiddle = RecomendationCoffeeStackView(text: recomendations[1].0,
                                                                                        image: recomendations[1].1)
    private lazy var reccomendationCoffeeStackViewRight = RecomendationCoffeeStackView(text: recomendations[2].0,
                                                                                       image: recomendations[2].1)
